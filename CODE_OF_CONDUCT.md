...
We as members, contributors, and leaders pledge to make participation in the LemonCake community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
- **Misuse of LemonCake credentials, payment infrastructure, or APIs to harm other users** (e.g. fund draining, replay attacks against other buyers' tokens, spam abuse of the marketplace)
...
This Code of Conduct applies within all community spaces (GitHub repos, Discord, X discussions, in-person events) and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at:

- 📧 **conduct@lemoncake.xyz** (private email)
- Or directly to founder via Discord DM (link on lemoncake.xyz)
...
**Community Impact**: Demonstrating a pattern of violation of community standards, including sustained inappropriate behavior, harassment of an individual, or aggression toward or disparagement of classes of individuals. Also: confirmed abuse of LemonCake infrastructure for fraud or harm.

**Consequence**: A permanent ban from any sort of public interaction within the community, plus revocation of any LemonCake API credentials.
