...
| 02 | [security-whitepaper.md](./02-security-whitepaper.md) | 情報セキュリティ | 認証（JWT HMAC-SHA256）、データ暗号化、Kill Switch の原子性、脅威モデル |
...
> - **認証方式:** Buyer JWT（HMAC-SHA256 署名）、Dify 暗号化クレデンシャル ストアに保管
